...
# main.py Yfinance Trand, Buy/Sell Signal and sentiment Analysis_ Corparate Actions Earnings 
import os
import logging
import yaml
...
# # main.py Yfinance Trand, Buy/Sell Signal and sentiment Analysis_ Corparate Actions Earnings _ with Retry
